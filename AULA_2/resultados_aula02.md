...
* **Tempo de execução:** 0.000149 segundos
* **Melhor valor encontrado:** 9
* **Combinação ótima (0=não leva, 1=leva):** (1, 1, 0, 1, 1)
...
2. **O que aconteceria se eu colocasse 15 itens?**
   * **Resp:** Ele passaria a ter 32.768 soluções possíveis, e de acordo com o peso e valor benefício de cada item, ele selecionaria as melhores opções dentro da capacidade total da mochila.

3. **Vocês conseguem imaginar um problema da vida real que seja parecido com este?**
